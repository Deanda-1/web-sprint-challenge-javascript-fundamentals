...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// You can use nestedFunction to access the variable (internal) because it is located within the scope of myFunction.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
   const smallAnimals = zooAnimals.map((element) => element.animal_name.toLowerCase())
    return (smallAnimals);
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const animals = zooAnimals.filter(element => element.population < 5)
    return (animals)
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    return(zooAnimals.reduce((pv, cv) => pv + cv.population, 0))
  }
...
// console.log(CuboidMakerTwo.surfaceArea()); // 130
